...
\begin{document}
	...
	En esta sección tras analizar los artículos principales de los creadores de Yolo \cite{redmon2016lookonceunifiedrealtime}\cite{redmon2016yolo9000betterfasterstronger}\cite{redmon2018yolov3incrementalimprovement}\cite{bochkovskiy2020yolov4optimalspeedaccuracy} y el diagrama de la red mediante la herramienta \textit{Netron}
	
	Para el blocke resnet \cite{he2015deepresiduallearningimage} de la figura \ref{fig:standard_bottleneck}
	\begin{figure}[H]
		\centering
