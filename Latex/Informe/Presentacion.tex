...
\begin{document}
	...
	\begin{frame}{Arquitectura y Funcionamiento de YOLO}
		\begin{figure}[H]
			\centering
			% Ajusté ligeramente el ancho para que se vea mejor el detalle
			\includegraphics[width=0.7\linewidth]{screenshot001} 
			\caption{Esquema de predicción unificada: de la rejilla a la detección final.}
			\label{fig:screenshot001}
		\end{figure}
		
		\vspace{-0.2cm} % Ajuste fino para ganar espacio
